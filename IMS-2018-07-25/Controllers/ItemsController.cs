...
namespace IMS_2018_07_25.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description,StatusId,CategoryId,Cost")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description,StatusId,CategoryId,Cost")] Item item)
        {
            if (ModelState.IsValid)
            {
